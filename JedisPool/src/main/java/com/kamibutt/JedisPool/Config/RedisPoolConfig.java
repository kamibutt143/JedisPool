...
public class RedisPoolConfig {
	...
	public RedisPoolConfig(Properties props){
		...
		this.setMinEvictableIdleTimeMillis(Integer.parseInt(props.getProperty("redisPoolConfig.minEvictableIdleTimeMillis")));
		this.setTimeBetweenEvictionRunsMillis(Integer.parseInt(props.getProperty("redisPoolConfig.timeBetweenEvictionRunsMillis")));
